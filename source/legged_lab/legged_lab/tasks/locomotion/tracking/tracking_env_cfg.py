...
import legged_lab.tasks.locomotion.tracking.mdp as mdp
from legged_lab.envs import ManagerBasedMotionDataEnvCfg
...
class TrackingSceneCfg(InteractiveSceneCfg):
    """Configuration for motion tracking scenes."""
...
class CommandsCfg:
    ...
    motion = mdp.MotionTrackingCommandCfg(
        asset_name="robot",
...
@configclass
class ActionsCfg:
    """Action specifications for motion tracking."""
...
@configclass
class EventCfg:
    """Event terms for motion tracking."""
...
class TerminationsCfg:
    ...
    ee_body_pos = DoneTerm(
        ...
        params={"command_name": "motion", "threshold": 0.25, "body_names": MISSING},
    )


@configclass
class CurriculumCfg:
    """Curriculum terms for motion tracking."""
...
class MotionDataCfg:
    ...
    motion_dataset = MotionDataTerm(motion_data_dir="", motion_data_weights={}, key_body_names=[])


@configclass
class TrackingEnvCfg(ManagerBasedMotionDataEnvCfg):
    """Configuration for motion tracking environments."""
